...
class RandomActuator(Actuator):
    ...
    def load(cls, data: dict = None):
        """Load data and create a new RandomActuator our of it.
...
class PathActuator(Actuator):
    ...
    @classmethod
    def load(cls, data: dict = None):
        """Load data and create a new PathActuator our of it.
...
class PatrolActuator(PathActuator):
    ...
    @classmethod
    def load(cls, data: dict = None):
        """Load data and create a new PatrolActuator our of it.
...
class UnidirectionalActuator(Actuator):
    ...
    @classmethod
    def load(cls, data: dict = None):
        """Load data and create a new UnidirectionalActuator our of it.
...
class PathFinder(Behavioral):
    ...
    @classmethod
    def load(cls, data: dict = None):
        """Load data and create a new PathFinder our of it.
