...
mygame.add_menu_entry('main_menu',None,'='*22)
mygame.add_menu_entry('main_menu','1',Utils.red_dim('A cool menu in dim red'))
mygame.add_menu_entry('main_menu','2',Utils.magenta_bright('Another cool menu in bright magenta'))
...
while True:
    ...
    if message != None:
        print(message)
        # We don't want to print the message more than once, so we put the message to None once it's printed.
        message = None
